...
st.sidebar.markdown("Dsenvolvido por [Vinicius Limeira](https://www.linkedin.com/in/vinicius-limeira-565117180/)")

btn = st.button("Acesse os dados no Kaggle")
if btn:
    webbrowser.open_new_tab("https://www.kaggle.com/datasets/stefanoleone992/fifa-23-complete-player-dataset/data")
